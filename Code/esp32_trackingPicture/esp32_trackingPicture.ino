...
//
//    CENTROID TRACKING WITH BRUTE FORCE OPTIMAL DISTANCE COMBINATIONS -> operations grows factorial with crab count so does not work with big amounts of crabs
//
void trackAndCount() {
